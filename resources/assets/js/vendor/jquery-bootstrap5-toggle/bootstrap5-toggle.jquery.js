/**
 * Forked from palcarazm/bootstrap5-toggle and improved the plugin management
...
(function (factory) {
  ...
  Toggle.prototype.render = function () {
    ...
    // 5: Toggle
    let $toggle = $(
      '<div class="toggle btn" data-bs-toggle="toggle" role="button">',
    )
      .addClass(
    ...
    if (this.options.offvalue) {
      ...
      $invElement.attr("data-bs-toggle", "invert-toggle");
  ...
  /**
   * Replace all `input[type=checkbox][data-bs-toggle="toggle"]` inputs with "Bootstrap-Toggle"
