/**
 * Forked from elboletaire/password-strength-meter and improved the plugin management
 *      (the original was generating errors like '$2 is undefined' & '$ is not a function'
 *
...
(function (factory) {
  ...
  var Password = function ($object, options) {
    ...
    function calculateColorFromPercentage(perc) {
      ...
      if (
        Object.prototype.hasOwnProperty.call(options.customColorBarRGB, "red")
      ) {
      ...
      if (
        Object.prototype.hasOwnProperty.call(options.customColorBarRGB, "green")
      ) {
      ...
      if (
        Object.prototype.hasOwnProperty.call(options.customColorBarRGB, "blue")
      ) {
    ...
    } // end calculateColorFromPercentage
    ...
    function init() {
      ...
      $object
        .closest(options.closestSelector)
