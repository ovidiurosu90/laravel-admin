/**
 * Forked from Eonasdan/tempus-dominus and improved the plugin management
 *      (the original was generating errors like 'tempusDominus is not defined' & '$ is not a function'
 *
 * @link https://github.com/Eonasdan/tempus-dominus/blob/master/src/js/jQuery-provider.js
 * @license MIT
 */
(function (factory) {
  if (typeof define === "function" && define.amd) {
    // AMD. Register as an anonymous module.
    define(["jquery", "~tempus-dominus/dist/js/tempus-dominus.js"], factory);
  } else if (typeof exports === "object") {
    // Node/CommonJS
    factory(
      require("jquery"),
      require("~tempus-dominus/dist/js/tempus-dominus.js"),
    );
  } else {
    // Browser globals
    factory(jQuery, tempusDominus, undef);
  }
