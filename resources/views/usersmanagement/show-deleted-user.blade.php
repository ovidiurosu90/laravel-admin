                    ...
                    <div class="card-header bg-danger text-white">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="float-right">
                                <a href="/users/deleted/" class="btn btn-light btn-sm float-right" data-bs-toggle="tooltip" data-bs-placement="left" title="{{ trans('usersmanagement.usersBackDelBtn') }}">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-md-6">
                                ...
                                @if ($user->profile)
                                <div class="text-center text-left-tablet mb-4">                                    {{ html()->form('POST', action([App\Http\Controllers\SoftDeletesController::class, 'update'], $user->id))
                                        ->class('form-inline')
                                        ->open() }}
                                        @csrf
                                        @method('PUT')
                                        {{ html()->button('<i class="fa fa-refresh fa-fw" aria-hidden="true"></i> Restore User')
                                            ->class('btn btn-success w-100 btn-sm mt-1 mb-1')
                                            ->type('submit')
