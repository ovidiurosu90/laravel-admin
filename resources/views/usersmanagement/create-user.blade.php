                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="pull-right">
                                <a href="{{ route('users') }}" class="btn btn-light btn-sm float-right" data-bs-toggle="tooltip" data-bs-placement="left" title="{{ trans('usersmanagement.tooltips.back-users') }}">
                    ...
                    <div class="card-body">
                        {{ html()->form('POST', route('users.store'))
                            ...
                            <div class="mb-3 has-feedback row {{ $errors->has('email') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {{ html()->email('email', old('email'))->id('email')->class('form-control')->placeholder(trans('forms.create_user_ph_email')) }}
                            ...
                            <div class="mb-3 has-feedback row {{ $errors->has('name') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {{ html()->text('name', old('name'))->id('name')->class('form-control')->placeholder(trans('forms.create_user_ph_username')) }}
                                        <div class="input-group-append">
                            ...
                            <div class="mb-3 has-feedback row {{ $errors->has('first_name') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {{ html()->text('first_name', old('first_name'))->id('first_name')->class('form-control')->placeholder(trans('forms.create_user_ph_firstname')) }}
                                        <div class="input-group-append">
                            ...
                            <div class="mb-3 has-feedback row {{ $errors->has('last_name') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {{ html()->text('last_name', old('last_name'))->id('last_name')->class('form-control')->placeholder(trans('forms.create_user_ph_lastname')) }}
                                        <div class="input-group-append">
