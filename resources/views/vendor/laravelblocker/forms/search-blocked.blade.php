        ...
        {!! form()->open([
            ...
            <div class="input-group mb-3">
                ...
                <div class="input-group-append">
                    <a href="#" class="btn btn-warning clear-search" style="display: none;" data-bs-toggle="tooltip" title="{!! trans('laravelblocker::laravelblocker.tooltips.clear-search') !!}">
                    ...
                    @if(config('laravelblocker.blockerEnableFontAwesomeCDN'))
                        {!! form()->button('<i class="fa fas fa-search" aria-hidden="true"></i> <span class="visually-hidden"> ' . trans('laravelblocker::laravelblocker.tooltips.submit-search') . ' </span>', ['class' => 'btn btn-secondary', 'type' => 'submit', 'data-bs-toggle' => 'tooltip', 'data-bs-placement' => 'bottom', 'title' => trans('laravelblocker::laravelblocker.tooltips.submit-search')]) !!}
                    @else
