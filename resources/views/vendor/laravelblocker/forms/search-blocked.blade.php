        ...
        {!! Form::open([
            ...
            <div class="input-group mb-3">
                ...
                <div class="input-group-append">
                    ...
                    @if(config('laravelblocker.blockerEnableFontAwesomeCDN'))
                        {!! Form::button('<i class="fa fas fa-search" aria-hidden="true"></i> <span class="visually-hidden"> ' . trans('laravelblocker::laravelblocker.tooltips.submit-search') . ' </span>', ['class' => 'btn btn-secondary', 'type' => 'submit', 'data-bs-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => trans('laravelblocker::laravelblocker.tooltips.submit-search')]) !!}
                    @else
