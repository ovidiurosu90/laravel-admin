            ...
            @if($blocked->count() > 0)
                @foreach($blocked as $blockedItem)
                    <tr>
                        ...
                        @if($tabletype == 'normal')
                            <td>
                                <a class="btn btn-sm btn-info btn-block text-white" href="/blocker/{{ $blockedItem->id }}" data-bs-toggle="tooltip" title="{{ trans("laravelblocker::laravelblocker.tooltips.show") }}">
                                    {!! trans("laravelblocker::laravelblocker.buttons.show") !!}
                                </a>
                            </td>
                            <td>
                                <a class="btn btn-sm btn-warning btn-block text-white" href="/blocker/{{ $blockedItem->id }}/edit" data-bs-toggle="tooltip" title="{{ trans("laravelblocker::laravelblocker.tooltips.edit") }}">
                        ...
                        @if($tabletype == 'deleted')
                            <td>
                                <a class="btn btn-sm btn-info btn-block text-white" href="/blocker-deleted/{{ $blockedItem->id }}" data-bs-toggle="tooltip" title="{{ trans("laravelblocker::laravelblocker.tooltips.show") }}">
                                    {!! trans("laravelblocker::laravelblocker.buttons.show") !!}
                                </a>
                            </td>
                            <td>
