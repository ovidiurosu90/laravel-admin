...
@section('content')
                    ...
                    <div class="{{ $containerBodyClass }}">
                        ...
                        <div class="row">
                            <div class="col-sm-6 mt-3">
                                ...
                                @else
                                    <a class="btn btn-sm btn-secondary btn-block text-white mb-0" href="{{ route('laravelroles::roles.edit', $item->id) }}" data-bs-toggle="tooltip" title="{{ trans("laravelroles::laravelroles.tooltips.edit-role") }}">
    ...
    @include('laravelroles::laravelroles.modals.confirm-modal',[
        'formTrigger' => 'confirm-destroy-roles-modal',
        'modalClass' => 'danger',
        'actionBtnIcon' => 'fa-trash-o'
    ])

    @include('laravelroles::laravelroles.modals.confirm-modal',[
        'formTrigger' => 'confirm-restore-roles-modal',
        'modalClass' => 'success',
        'actionBtnIcon' => 'fa-check'
    ])
...
@section(config('roles.bladePlacementJs'))
    ...
    @include('laravelroles::laravelroles.scripts.confirm-modal', ['formTrigger' => 'confirm-destroy-roles-modal'])
    @include('laravelroles::laravelroles.scripts.confirm-modal', ['formTrigger' => 'confirm-restore-roles-modal'])
    @if (config('roles.enabledDatatablesJs'))
