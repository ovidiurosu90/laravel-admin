...
@section('content')
                    ...
                    <div class="{{ $containerBodyClass }}">
                        ...
                        <div class="row">
                            <div class="col-sm-6 mt-3">
                                ...
                                @else
                                    <a class="btn btn-sm btn-secondary btn-block text-white mb-0" href="{{ route('laravelroles::permissions.edit', $item['permission']->id) }}" data-bs-toggle="tooltip" title="{{ trans("laravelroles::laravelroles.tooltips.edit-permission") }}">
    ...
    @include('laravelroles::laravelroles.modals.confirm-modal',[
        'formTrigger' => 'confirm-restore-permissions-modal',
        'modalClass' => 'success',
        'actionBtnIcon' => 'fa-check'
    ])

    @include('laravelroles::laravelroles.modals.confirm-modal',[
        'formTrigger' => 'confirm-destroy-permissions-modal',
        'modalClass' => 'danger',
        'actionBtnIcon' => 'fa-trash-o'
    ])
...
@section(config('roles.bladePlacementJs'))
    ...
    @endif
    @include('laravelroles::laravelroles.scripts.confirm-modal', ['formTrigger' => 'confirm-restore-modal'])
    @include('laravelroles::laravelroles.scripts.confirm-modal', ['formTrigger' => 'confirm-delete-modal'])
    @include('laravelroles::laravelroles.scripts.confirm-modal', ['formTrigger' => 'confirm-restore-permissions-modal'])
    @include('laravelroles::laravelroles.scripts.confirm-modal', ['formTrigger' => 'confirm-destroy-permissions-modal'])
    @if (config('roles.enabledDatatablesJs'))
