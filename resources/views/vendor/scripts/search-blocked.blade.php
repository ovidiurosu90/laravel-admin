                ...
                success: function (result) {
                    ...
                    if (jsonData.length != 0) {
                        $.each(jsonData, function(index, val) {
                            ...
                            @if($searchtype == 'normal')
                                var showCellHtml = '<a class="btn btn-sm btn-success w-100" href="blocker/' + val.id + '" data-bs-toggle="tooltip" title="{{ trans("laravelblocker::laravelblocker.tooltips.show") }}">{!! trans("laravelblocker::laravelblocker.buttons.show") !!}</a>';
                                var editCellHtml = '<a class="btn btn-sm btn-info w-100" href="blocker/' + val.id + '/edit" data-bs-toggle="tooltip" title="{{ trans("laravelblocker::laravelblocker.tooltips.edit") }}">{!! trans("laravelblocker::laravelblocker.buttons.edit") !!}</a>';
